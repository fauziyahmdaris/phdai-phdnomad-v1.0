/*
  ...
  1. Security
    - Fixes function_search_path_mutable warnings for both functions
    - Ensures proper SECURITY DEFINER settings
    - Explicitly sets search_path to public to prevent search path manipulation

  This migration addresses the remaining security warnings in the Supabase dashboard
  by properly setting the search_path parameter for both functions.
*/
